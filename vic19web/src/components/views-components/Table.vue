<template>
    <div>
        ...
        <div class="paginator-container">
            ...
            <v-icon v-bind:class="{ 'paginator-button': page<=0,'paginator-button-active': page>0 }" v-on:click="previusPage">mdi-chevron-left</v-icon>
            <v-icon  v-bind:class="{ 'paginator-button': total-10-page*10<=0,'paginator-button-active': total-10-page*10>0 }"  v-on:click="nextPage">mdi-chevron-right</v-icon>
        </div>
    </div>
